...
console.log("after pop value from last of array we have :", arrayAfterPop, " and deleted item is:", deletedvalue);
console.log("after push value in first of array we have ", arrayAfterpushInfirst);
